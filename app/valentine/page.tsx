...
export default function ValentinePage() {
    ...
    useEffect(() => {
        ...
        // Preload all images to prevent flash when swiping
        MEMORIES.forEach((memory, index) => {
            if (memory.type === 'image') {
                ...
                // Video/TikTok - mark as loaded immediately
                setLoadedImages(prev => new Set(prev).add(index));
            }
        });
                            ...
                            <div className="flex-1 flex items-center justify-center w-full py-2">
                                ...
                                {(MEMORIES[currentSlideIndex]?.type === 'youtube' ||
                                    ...
                                    MEMORIES[currentSlideIndex]?.type === 'video') && (
                                        <Button
                                            variant="contained"
                                            onClick={() => setActiveVideo(MEMORIES[currentSlideIndex])}
                    ...
                    >
                        ...
                        >
                            {activeVideo.type === 'youtube' ? (
                                <iframe
                                    src={`https://www.youtube.com/embed/${activeVideo.url}?autoplay=1&controls=1&rel=0`}
                                ...
                                <iframe
                                    src={`https://www.tiktok.com/player/v1/${activeVideo.url}?music_info=1&description=1&autoplay=1&volume_control=1&loop=1`}
                                    className="w-full h-full"
