            ...
            <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
                <Stack spacing={{ xs: 4, md: 6 }} alignItems="center" textAlign="center">
                    ...
                    <Stack spacing={2} alignItems="center">
                        ...
                        >
                            <span style={{ color: "var(--primary)" }}>ผู้นำการเช่าจอ LED และจัดอีเว้นท์</span> <br />
                        ...
                        >
                            SET EVENT Thailand มุ่งมั่นสร้างสรรค์ประสบการณ์ที่เหนือระดับ เพราะว่า เราคือผู้เชี่ยวชาญด้านบริการจัดงานอีเว้นท์ครบวงจรและ<strong>จัดงานราคาประหยัด</strong>ที่ได้รับความไว้วางใจมาอย่างยาวนาน นอกจากนี้ ทีมงานของเราพร้อมดูแลตั้งแต่วันแต่งงาน งานสัมมนา ไปจนถึงคอนเสิร์ตขนาดใหญ่ เพื่อให้ มั่นใจว่าทุกรายละเอียดจะสมบูรณ์แบบที่สุด ดังนั้น หากคุณกำลังมองหาบริการ<strong>เช่าจอ LED ราคาถูก</strong> และระบบแสงสีเสียงมาตรฐานสากล เราพร้อมเป็นส่วนหนึ่งที่ช่วยให้งานของคุณคุ้มค่าและน่าประทับใจที่สุด
                        </Typography>
                    </Stack>
