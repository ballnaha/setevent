            ...
            <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
                <Stack spacing={{ xs: 4, md: 6 }} alignItems="center" textAlign="center">
                    ...
                    <Stack spacing={2} alignItems="center">
                        ...
                        >
                            SET EVENT Thailand มุ่งมั่นสร้างสรรค์ประสบการณ์ที่เหนือระดับ <strong>เพราะว่า</strong> เราคือผู้เชี่ยวชาญด้านบริการจัดงานอีเวนต์ครบวงจรและ<strong>จัดงานราคาประหยัด</strong>ที่ได้รับความไว้วางใจมาอย่างยาวนาน <strong>นอกจากนี้</strong> ทีมงานของเราพร้อมดูแลตั้งแต่วันแต่งงาน งานสัมมนา ไปจนถึงคอนเสิร์ตขนาดใหญ่ <strong>เพื่อให้</strong> มั่นใจว่าทุกรายละเอียดจะสมบูรณ์แบบที่สุด <strong>ดังนั้น</strong> หากคุณกำลังมองหาบริการ<strong>เช่าจอ LED ราคาถูก</strong> และระบบแสงสีเสียงมาตรฐานสากล เราพร้อมเป็นส่วนหนึ่งที่ช่วยให้งานของคุณคุ้มค่าและน่าประทับใจที่สุด
                        </Typography>
                    </Stack>
