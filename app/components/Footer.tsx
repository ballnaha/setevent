                ...
                <Box sx={{
                    ...
                    <Box>
                        ...
                        <Typography sx={{
                            ...
                            ผู้นำด้านการให้บริการ<strong>เช่าจอ LED</strong> และ<strong>จัดงานครบวงจร</strong> ระบบแสง สี เสียง และโครงสร้างเวที พร้อมทีมงานติดตั้งมืออาชีพ
                        </Typography>
                            ...
                            {settings.facebook && (
                                <IconButton
                                    ...
                                    sx={{
                                        ...
                                        '&:hover': { bgcolor: '#E94560', borderColor: '#E94560' }
                                    }}
                                >
