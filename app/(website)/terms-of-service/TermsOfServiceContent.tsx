...
export default function TermsOfServiceContent() {
    ...
    const sections = [
        ...
        },
        {
            ...
            content: "เราให้บริการเช่าจอ LED, เครื่องเสียง, เวที และอุปกรณ์จัดงานอีเว้นท์ รวมถึงบริการติดตั้ง รื้อถอน และควบคุมระบบ โดยรายละเอียดการให้บริการจะถูกระบุไว้ในใบเสนอราคาที่ทั้งสองฝ่ายตกลงกัน"
        },
        {
