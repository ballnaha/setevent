...
import { Call, Message, Location, Instagram, Facebook, Sms, MessageText, Youtube } from "iconsax-react";
...
export default function ContactContent() {
    ...
    const socialItems = [
        ...
        ...(settings.youtube ? [{ icon: <Youtube size="22" variant="Bold" color="var(--primary)" />, label: 'YouTube', url: settings.youtube }] : [])
    ];
